...
export default function AIActionCard({ icon, title, subtitle, colors, onPress }: AIActionCardProps) {

    const [width, setWidth] = useState(0);
    const diag = width > 0 ? Math.sqrt(2 ** 2 + CARD_HEIGHT ** 2) * 4 : 0;
    ...
    return (
        <TouchableOpacity onPress={onPress} activeOpacity={0.85} style={{ flex: 1 }}>
            ...
            >
                ...
                >
                    <View className="items-center justify-center mb-3 rounded-full w-9 h-9 bg-white/20">
